  ...
  en: {
    ...
    deploy: {
      steps: [
        ...
        { title: 'Extract the CE release', desc: 'The tar ships the service binaries, the panel and the JavaScript SDK side by side.', code: 'tar -xzf co-stage-ce-v0.2.1-linux-amd64.tar.gz' },
      ...
      term: [
        ...
        { cls: 'out', text: '[manager] CoStage deployment manager v0.2.1' }, { cls: '', text: '\n' },
  ...
  zh: {
    ...
    deploy: {
      steps: [
        ...
        { title: '解压 CE 发布包', desc: 'tar 包内含服务二进制、面板与 JavaScript SDK。', code: 'tar -xzf co-stage-ce-v0.2.1-linux-amd64.tar.gz' },
